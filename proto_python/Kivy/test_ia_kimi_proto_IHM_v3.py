...
# Texte tourné de 90° (carte utilisée sur le côté)
...
txt_couleur = gui.draw_text(
    ...
    font_size=16,
    color="black",
    angle=-90      # texte tourné de 90° (sens horaire quand tu tournes la carte à droite)
)
...
# Boutons bas de page (leur texte ne peut pas être pivoté avec add_button)
def show_ip():
    show_page("ip")
